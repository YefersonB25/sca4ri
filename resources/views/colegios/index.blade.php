...
@section('content_header')
    <h1 class="text-center" style="text-decoration: underline">Colegios</h1>
@stop
...
<div class="card" id="oculto-crear" style="display: none">
    <h3 class="text-center" style="text-decoration: underline">Importar colegios</h3>
    <div class="card-body"> 
        <form  method="post" action="{{ route('import') }}" class="needs-validation" novalidate enctype="multipart/form-data">
            @csrf
            ...
            <tbody>
                @foreach ($colegios as $colegio)
                    <tr>
                        ...
                        <td>{{ $colegio->col_dane_colegio }}</td>
                        <td>{{ $colegio->col_nombre }}</td>
                        <td>
                            <a href="{{ route('sedes.index', $colegio->id) }}" class="btn btn-primary"><i class="fa fa-fw fa-hotel"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
...
<script>
    ...
    Toast.fire({
        icon: 'success',
        title: 'Colegios importados correctamente'
    })
</script>
...
@endif
    ...
    <script>
        ...
        Swal.fire({
        title: '<strong>Agregar <u>Estudiante</u></strong>',
        icon: 'info',
        html:
            'Para agregar un <b>estudiante</b>, diríjase al colegio, sede, curso y grupo ' + 
